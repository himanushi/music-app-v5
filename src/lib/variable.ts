...
export const googleAnalyticsId = getContent("meta[property='ms:google-analytics-id']");

export const appleAffiliateToken = getContent("meta[property='ms:apple-affiliate-token']");

export const twitterAccount = getContent("meta[property='ms:twitter-account']") || "vgm_net";
